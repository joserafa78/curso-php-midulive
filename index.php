...
<body>
    <header>
        <div id="wrapper">
            <img src="img/portada.png" id="logo" alt="Crafty" style="width: 500px; height: 300px;">
            <h1>Curso PHP - MeduLive</h1>
            <h5>Aqui encontraras todo el codigo y Practicas de mi cruso.. Gracias.</h5>
